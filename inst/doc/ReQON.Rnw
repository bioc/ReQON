...
\textbf{THERE HAVE BEEN SEVERAL CRITICAL UPDATES TO THE ReQON SOFTWARE.  MAKE SURE THAT YOU HAVE DOWNLOADED AND ARE RUNNING ReQON VERSION 1.3.5 
...
\texttt{nerr} and \texttt{nraf} were added in version 1.3.0.  We strongly recommend using version 1.3.5 or later as some earlier verions are not fully
